...
function profile(state = { username:'', headline: '', avatar: '', zipcode: '', email: '', phone: '', bday: '' }, action) {
    switch (action.type) {
        ...
        case Action.UPDATE_PROFILE:
            ...
            if (action.bday) return { ...state, bday: action.bday}
...
function common(state = { error:'', success:'', location:'' }, action) {
    ...
    switch (action.type) {
        ...
        case Action.SIDE_OUT:
            return { ...state, ...clean, sidebar: true}
        default:
            return { ...state, ...clean }
    }
}
